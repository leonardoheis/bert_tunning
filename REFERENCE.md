# Bert Tunning — Full Reference

Detailed reference for this project. For a quick start and the critical parts you need to
know before touching anything, see [README.md](README.md).
...
> A Config page for live W&B logging (`GET/POST /config/wandb`, `POST /config/wandb/credentials`)
> was designed (`docs/superpowers/specs/2026-07-20-config-page-model-switch-and-wandb-design.md`)
> but is **not implemented** — no such endpoints exist yet. Removed from this doc after being
> listed here inaccurately; check the spec file for the design if you pick this up.
